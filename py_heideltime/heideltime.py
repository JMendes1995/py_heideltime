...
def heideltime(text):
    ...
    myCmd = os.popen(
        'java -jar HeidelTime/de.unihd.dbs.heideltime.standalone.jar news -l ' + lang_name + ' text.txt').read()
